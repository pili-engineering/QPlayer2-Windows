...
std::list<ChildMenu*>* PlayerMenuSettingModelManager::create_mute_list() {
	...
	case true: {
		...
		pmute_list->emplace_back(create_child_menu("非静音", ID_MUTE_CLOSE_BUTTON, false));
		pmute_list->emplace_back(create_child_menu("静音", ID_MUTE_OPEN_BUTTON, true));
		break;
	}
	case false: {

		pmute_list->emplace_back(create_child_menu("非静音", ID_MUTE_CLOSE_BUTTON, true));
		pmute_list->emplace_back(create_child_menu("静音", ID_MUTE_OPEN_BUTTON, false));
		break;
	}
	default:
		pmute_list->emplace_back(create_child_menu("非静音", ID_MUTE_CLOSE_BUTTON, true));
